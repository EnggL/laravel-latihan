...
<div class="container">
    <div class="row">
        <div class="col-md">
            <h1 style="text-align: center; margin-top: 20px;">Tambah Data Siswa</h1>
            @if ($errors->any())
            ...
            @endif
            <form method="post" action="{{url('/students/save')}}" id="formAddStudent">
                @csrf
                <div class="col-md">
                    <h5>Nama Siswa</h5>
                </div>
            ...
            <div class="col-md" style="margin-top: 50px; text-align: center;">
                <button type="button" class="btn btn-warning btn-lg" style="margin-right: 50px;"
                    id="btnCancleAddStudent">
                    <i class="bi bi-chevron-double-left"></i> Kembali
                </button>
                <button type="button" class="btn btn-success btn-lg" id="btnAddEditStudent">
...
<script type="text/javascript" src="{{ URL::asset('js/student/student-add.js') }}"></script>